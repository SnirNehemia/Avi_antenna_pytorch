...
if __name__ == '__main__':
    ...
    output_folder = r"G:\General_models\output_monopole"
    ...
    cst_path = r"G:\General_models\Monopole.cst"
    ...
    model_parameters_limits = {
        'wx': [1,2.5],
        'l': [2.5,30],
        'dielectric_buffer_x': [0, 5],
        'dielectric_thickness': [0.1, 3.2],
        'dielectric_buffer_z': [0,5],
        'ground_x': [10,200],
        'ground_y': [10, 200]
    }
    model_parameters = { # the constant ones
