...
def open_cst():
    ...
    final_dir = os.path.join(r'G:\Pixels', r'Avi_runs')
...
if __name__ == '__main__':
    # TODO: change all paths based on local paths in this computer
    # Path to the directory that contains the folders
    overall_sim_time = time.time()
    parent_dir = r'C:\Users\snirnehemia\Downloads\antenna_FMNIST_Test'
    ...
    CST_output_dir = r'G:\Pixels\Avi_runs\output_avi_no_reflectors'
    ...
    for folder in folders:
        ...
        # your STLs
        target_STL_folder = r'G:\Pixels\Avi_runs\STLs - Avi'  # DO NOT CHANGE!

        # clear CST cash:
        cash_path = r'G:\Pixels\Avi_runs\CST_pixels_10_no_reflectors - Avi\Result'
